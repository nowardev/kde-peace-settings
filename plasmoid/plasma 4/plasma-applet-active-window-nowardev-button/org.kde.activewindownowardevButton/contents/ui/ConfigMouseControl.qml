...
Item {
    ...
    property alias cfg_middleClickCloseWindow: middleClickCloseWindow.checked
//     property alias cfg_doubleClickMinimizes: doubleClickMinimizes.checked
...
//         CheckBox {
//             id: doubleClickMinimizes
//             text: i18n("Doubleclick to sttoggle minimizing")
//         }
//         Item {
//             width: 2
//             height: 2
//         }
        CheckBox {
            id: middleClickCloseWindow
            text: i18n("Middleclick to Close Window")
        }
