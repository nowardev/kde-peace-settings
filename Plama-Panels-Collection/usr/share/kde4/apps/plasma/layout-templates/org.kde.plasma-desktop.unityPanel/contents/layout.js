...
function unity(){
	...
	if (panelIds.length == 1) {
		...
		panel.height = screenrect.height/30;
			...
			kwinbutton.writeConfig("ActionType", "1")
			...
			var kwinbutton = panel.addWidget ("kwinbutton")
			// kwinbutton.currentConfigGroup = new Array('Configuration')
			kwinbutton.writeConfig("ActionType", "2")
			kwinbutton.writeConfig("Maximized", "1")
			
			var kwinbutton = panel.addWidget ("kwinbutton")
			// kwinbutton.currentConfigGroup = new Array('Configuration')
			kwinbutton.writeConfig("ActionType", "3")
			kwinbutton.writeConfig("Maximized", "1")
			...
			var kwinbutton = panel.addWidget ("kwinbutton")
			// kwinbutton.currentConfigGroup = new Array('Configuration')
			kwinbutton.writeConfig("ActionType", "4")
			kwinbutton.writeConfig("Maximized", "1")
